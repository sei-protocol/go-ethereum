...
// goroutine. Even after generation completes, the goroutine used to park waiting
// for an abort signal. If Release() does not stop it, it lingers and can touch the
